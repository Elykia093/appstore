...
| CLIProxyAPI | `7.3.11` | `eceasy/cli-proxy-api:v7.3.11` | `8317:8317` | `./config.yaml`、`./auths`、`./logs` |
...
| LX Sync Server | `2.1.0` | `ghcr.io/xcq0607/lxserver:v2.1.0` | `9527:9527` | `./data`、`./logs`、`./cache`、`./music`，WebDAV 参数由环境变量注入 |
