...
| CLIProxyAPI | `7.2.149` | `eceasy/cli-proxy-api:v7.2.149` | `8317:8317` | `./config.yaml`、`./auths`、`./logs` |
| Lsky Pro | `2.1` | `ghcr.io/walrus8364/lsky-pro:latest` | `8000:80` | `./data:/var/www/html`，PostgreSQL/Redis/Admin/License 由环境变量注入 |
| New API | `1.0.0-rc.32` | `calciumion/new-api:v1.0.0-rc.32` | `3000:3000` | `./data`、`./logs`，PostgreSQL DSN 由环境变量注入 |
