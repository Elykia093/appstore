...
| CPA / CLIProxyAPI | `7.2.58` | `eceasy/cli-proxy-api:v7.2.58` | `8317:8317` | `./config.yaml`、`./auths`、`./logs` |
...
| New API | `1.0.0-rc.20` | `calciumion/new-api:v1.0.0-rc.20` | `3000:3000` | `./data`、`./logs`，PostgreSQL DSN 由环境变量注入 |
